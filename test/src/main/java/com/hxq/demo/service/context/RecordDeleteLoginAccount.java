...
@Service
@Slf4j
public class RecordDeleteLoginAccount implements LogRecordService, InitializingBean {
    ...
    public void logRecord(int userId) {
        ...
        logRecord.setTitle("删除账号");
        logRecord.setCreateTime(new Date());
        logRecord.setContent(user.getUserName()+"("+user.getRoleName()+")删除了账号");
    ...
    public void afterPropertiesSet() throws Exception {
        RecordLogFactory.register("recordDeleteLoginAccount",this);
    }
}
