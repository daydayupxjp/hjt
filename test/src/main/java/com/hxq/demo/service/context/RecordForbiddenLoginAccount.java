...
@Service
@Slf4j
public class RecordForbiddenLoginAccount implements LogRecordService, InitializingBean {
    ...
    public void logRecord(int userId) {
        ...
        logRecord.setTitle("冻结账号");
        logRecord.setCreateTime(new Date());
        logRecord.setContent(user.getUserName()+"("+user.getRoleName()+")冻结了账号");
    ...
    public void afterPropertiesSet() throws Exception {
        RecordLogFactory.register("recordForbiddenLoginAccount",this);
    }
}
