...
@Service
@Slf4j
public class RecordLoginSite implements LogRecordService, InitializingBean {
    ...
    public void logRecord(int userId) {
        ...
        logRecord.setTitle("记录登陆地点");
        logRecord.setCreateTime(new Date());
        logRecord.setContent(user.getUserName()+"("+user.getRoleName()+")登录系统");
    ...
    public void afterPropertiesSet() throws Exception {
        RecordLogFactory.register("RecordLoginSite",this);
    }
