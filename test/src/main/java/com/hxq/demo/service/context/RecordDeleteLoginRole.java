...
@Service
@Slf4j
public class RecordDeleteLoginRole implements LogRecordService, InitializingBean {
    ...
    public void logRecord(int userId) {
        ...
        logRecord.setTitle("删除角色");
        logRecord.setCreateTime(new Date());
        logRecord.setContent(user.getUserName()+"("+user.getRoleName()+")删除了角色");
    ...
    public void afterPropertiesSet() throws Exception {
        RecordLogFactory.register("recordDeleteLoginRole",this);
    }
}
