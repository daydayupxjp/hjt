...
@Service
@Slf4j
public class RecordAddLoginAccount implements LogRecordService , InitializingBean {
    ...
    public void logRecord(int userId) {
        ...
        logRecord.setTitle("添加账号");
        logRecord.setCreateTime(new Date());
        logRecord.setContent(user.getUserName()+"("+user.getRoleName()+")添加了账号");
    ...
    public void afterPropertiesSet() throws Exception {
        RecordLogFactory.register("recordAddLoginAccount",this);
    }
}
