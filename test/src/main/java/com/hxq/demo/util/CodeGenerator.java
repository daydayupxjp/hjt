...
import com.hxq.demo.core.content.ProjectConstant;
 ...
 * @Description TODO
 * @Author hongxq
 * @Date 2019/11/2 0002 17:14
 * @Version 1.0
 **/
public class CodeGenerator {

    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/zokoo-test?serverTimezone=GMT%2B8";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "245338";
